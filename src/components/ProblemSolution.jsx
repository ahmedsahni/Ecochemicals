...
export default function ProblemSolution() {
  ...
  return (
    <section ref={containerRef} id="about-problem" className="relative py-24 bg-[#0B0F19] overflow-hidden px-4 sm:px-6 lg:px-8">
      {/* Background Grid */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            {/* Visual Container */}
            <div className="relative w-full max-w-[320px] aspect-[3/4] rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(37,99,235,0.2)] border border-slate-700 select-none bg-slate-900">
              ...
              >
                <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-[#0B0F19] border-2 border-cyan-400 flex items-center justify-center shadow-[0_0_20px_rgba(34,211,238,0.5)]">
