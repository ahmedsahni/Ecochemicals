...
export default function BrochureShowcase() {
  ...
  return (
    <section id="brochure" className="relative py-24 px-4 sm:px-6 lg:px-8 bg-[#0B0F19] overflow-hidden border-t border-slate-800">
      {/* Glow effect */}
      <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[600px] h-[600px] bg-cyan-600/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-xs font-bold text-cyan-300 tracking-widest uppercase">{t('brochureShowcase.tag')}</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div 
              ...
              className="relative group cursor-pointer max-w-[360px] w-full rounded-2xl overflow-hidden border border-slate-700/50 hover:border-cyan-500/50 shadow-2xl transition-all duration-300 bg-slate-900/40 p-2"
            >
              {/* Overlay on hover */}
              <div className="absolute inset-2 rounded-xl bg-slate-950/70 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center transition-all duration-300 z-20">
          ...
          <div className="lg:col-span-7 space-y-6">
            {highlights.map((item, idx) => (
              <motion.div
                ...
                className="group relative p-6 rounded-2xl glass-panel border border-slate-700/50 hover:border-cyan-500/40 transition-all duration-300 overflow-hidden"
              >
                {/* Glow background */}
                ...
                <div className="relative z-10 flex gap-4 items-start">
                  <div className="mt-1 flex-shrink-0 p-2.5 rounded-xl bg-slate-800 border border-slate-700 text-cyan-400 group-hover:scale-110 transition-transform">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-white mb-1.5 tracking-wide group-hover:text-cyan-300 transition-colors uppercase text-xs font-black tracking-widest text-cyan-400">
                      {item.title}
                    </h3>
