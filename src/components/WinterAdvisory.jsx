        ...
        >
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="flex gap-2 p-1.5 bg-slate-100 backdrop-blur-sm rounded-2xl border border-slate-200 mb-2">
                <button
              ...
              <AnimatePresence mode="wait">
                {activeTab === 'winter' ? (
                  <motion.div
                    ...
                    className="space-y-6"
                  >
                    <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 backdrop-blur-sm relative group hover:border-red-500/30 transition-colors">
                      <div className={`absolute ${language === 'ur' ? '-right-3' : '-left-3'} -top-3 w-8 h-8 rounded-full bg-slate-200 border border-slate-300 flex items-center justify-center shadow-lg`}>
                        <Snowflake className="w-4 h-4 text-blue-400 group-hover:rotate-45 transition-transform duration-500" />
                      </div>
                      <p className="text-slate-600 leading-relaxed font-medium">
                        {language === 'ur' ? (
                          <>
                            یہ عام مشاہدہ ہے کہ سردیوں کے شروع میں کولنگ پیڈز کو اکثر دھوئے بغیر <strong className="text-slate-900">۴ سے ۶ ماہ کے لیے بند کر دیا جاتا ہے</strong>۔ پیڈز کو صاف کیے بغیر بند کرنا انہیں مکمل طور پر تباہ کر دیتا ہے۔
                          </>
                        ) : (
                          <>
                            It is a common observation that at the onset of winter, cooling pads are often shut down for <strong className="text-slate-900">4 to 6 months without being washed</strong>. Closing the pads without proper cleaning completely destroys them.
                          </>
                        )}
                      </p>
                    </div>

                    <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 backdrop-blur-sm relative group hover:border-amber-500/30 transition-colors">
                      <div className={`absolute ${language === 'ur' ? '-right-3' : '-left-3'} -top-3 w-8 h-8 rounded-full bg-slate-200 border border-slate-300 flex items-center justify-center shadow-lg`}>
                    ...
                    <div className="p-5 rounded-2xl bg-red-50 border border-red-500/20 backdrop-blur-sm relative group hover:bg-red-50 transition-colors">
                  ...
                  <motion.div
                    ...
                    className="space-y-6"
                  >
                    <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 backdrop-blur-sm relative group hover:border-cyan-500/30 transition-colors">
                      <div className={`absolute ${language === 'ur' ? '-right-3' : '-left-3'} -top-3 w-8 h-8 rounded-full bg-slate-200 border border-slate-300 flex items-center justify-center shadow-lg`}>
                        <RefreshCw className="w-4 h-4 text-cyan-400 group-hover:rotate-180 transition-transform duration-500" />
                      </div>
                      <h3 className="text-lg font-bold text-slate-900 mb-2">{t('winterAdvisory.tip1Title')}</h3>
                      <p className="text-slate-600 leading-relaxed text-sm font-medium">
                        {t('winterAdvisory.tip1Desc1')}
                        <br /><br />
                        {t('winterAdvisory.tip1Desc2')}
                      </p>
                      <span className="text-amber-400 font-bold block mt-3 text-sm border-t border-slate-200 pt-2.5">
                    ...
                    <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 backdrop-blur-sm relative group hover:border-amber-500/30 transition-colors">
                      ...
                      <h3 className="text-lg font-bold text-slate-900 mb-2">{t('winterAdvisory.tip2Title')}</h3>
                      <p className="text-slate-600 leading-relaxed text-sm font-medium">
                        {t('winterAdvisory.tip2Desc1')}
                        <br /><br />
                        {t('winterAdvisory.tip2Desc2')}
                      </p>
                      <span className="text-red-400 font-bold block mt-3 text-sm border-t border-slate-200 pt-2.5">
